...
(() => {
	...
	const monthElement = <HTMLSelectElement | null>document.getElementById('PlGetOnMonth');
	const dayElement = <HTMLSelectElement | null>document.getElementById('PlGetOnDay');
	...
	/* 【条件指定フォーム】時刻プルダウンを編集 */
	const timeElement = <HTMLSelectElement | null>document.getElementById('PlGetOnTime');
	const hourElement = <HTMLSelectElement | null>document.getElementById('PlGetOnHour');

	if (timeElement !== null || hourElement !== null) {
		console.info('【条件指定フォーム】時刻プルダウンを編集');

		const targetElement = <HTMLSelectElement>(timeElement !== null ? timeElement : hourElement);
	...
	/* 【人数入力フォーム】人数欄の初期設定 */
	const adultNumberElement = <HTMLInputElement | null>document.getElementById('TxtAdultNumber');
	const childNumberElement = <HTMLInputElement | null>document.getElementById('TxtChildNumber');
